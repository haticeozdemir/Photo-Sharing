...
import kotlinx.android.synthetic.main.activity_isini_paylasma.*
import java.util.*

class IsiniPaylasmaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_isini_paylasma)
            ...
            gorselReference.putFile(secilenGorsel!!).addOnSuccessListener {taskSnapshot ->
               val yuklenenGorselReference = FirebaseStorage.getInstance().reference.child("images").child(gorselismi)
                yuklenenGorselReference.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    postHasMap.put("gurselurl",downloadUrl)
